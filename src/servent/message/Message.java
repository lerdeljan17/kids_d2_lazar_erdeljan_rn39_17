...
public interface Message extends Serializable {
	...
	int getSnapshotInitiatorId() ;

	void setSnapshotInitiatorId(int snapshotInitiatorId) ;

	ABSnapshotResult getSnapshotResult();

	void setSnapshotResult(ABSnapshotResult snapshotResult) ;
}
