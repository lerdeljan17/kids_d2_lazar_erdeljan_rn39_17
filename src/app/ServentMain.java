...
public class ServentMain {
	...
	public static void main(String[] args) {
		...
		List<CausalSendWorker> senderWorkers = new ArrayList<>();
...
//		}
				...
				// TODO: 13.5.2021. napravi causalong worker-a
				CausalSendWorker senderWorker = new CausalSendWorker(snapshotCollector);
